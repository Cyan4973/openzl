...
const InternalGraphDesc GR_standardGraphs[ZL_PrivateStandardGraphID_end] = {
    ...
    REGISTER_STATIC_GRAPH(ZL_PrivateStandardGraphID_constant_numeric, "!zl.private.constant_numeric", ZL_Type_numeric, ZL_PrivateStandardNodeID_constant_numeric, _1_SUCCESSOR(ZL_PrivateStandardGraphID_serial_store) ),
